...
<section class="product-detail">
    ...
    <div class="product-container">
        ...
        <form action="/cart" method="post">
            ...
            <p><strong>Thương hiệu: </strong> {{ $product->loai->tenLoai }}</p>
            <p class="description"><strong>Mô tả:</strong> {{ $product->moTa }}</p>
            <!-- Hàng chứa Giá & Số lượng -->
            <div class="price-quantity">
                <p class="price">Giá: {{ number_format($product->gia) }}đ</p>
                <div class="quantity-selector">
                    <label for="soluong">Số lượng:</label>
                    <input type="number" id="soluong" name="soluong" value="1" min="1" max="{{ $product->soluong }}">
                </div>
            </div>
