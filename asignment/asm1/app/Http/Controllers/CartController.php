    ...
    public function store(Request $request)
{
    ...
    if ($foundIndex !== null) {
        ...
        $cart[$foundIndex]['soluong'] += (int) $request->soluong;
    } else {
        ...
        'ten' => $request->ten,
        'gia' => (int) $request->gia,
        'anh' => $request->anh ?? 'default.png', // Gán hình mặc định nếu không có
    ...
    public function update(Request $request, $id)
{
    ...
    foreach ($cart as &$item) {
        if ($item['id'] == $id) {
            $item['soluong'] = $request->soluong; // Cập nhật số lượng mới
            break;
        }
    }
